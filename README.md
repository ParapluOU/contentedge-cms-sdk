...
npm install @contentedge-cms/sdk
# or
yarn add @contentedge-cms/sdk---
...
type ContentDto
} from '@contentedge/sdk';

// Auth (Keycloak client-credentials)
...
import type { ContentListParams, ContentDto } from '@contentedge/sdk';
